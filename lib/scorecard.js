...
// page onload & click functions
    ...
    $("#sort1").change(function() {reportResults();}); 
    $("#sort2").change(function() {reportResults();}); 
...
function reportResults() {
	...
	sessionStorage.sort1=$('#sort1').val();
	sessionStorage.sort2=$('#sort2').val();
...
// 4 = Opp pairs
	...
	var sortcombo=sessionStorage.sort1+sessionStorage.sort2;
	switch(true) {
	case (sortcombo<10): // sequence
		reportseq="123456789";
		homePair="123231312";
		awayPair="123123123";
		break;
	case (sortcombo==12): // home + away
		reportseq="186429753";
		homePair="111222333";
		awayPair="123123123";
		break;
	case (sortcombo<20): // home + sequence
		reportseq="168249357";
		homePair="111222333";
		awayPair="132213321";
		break;
	case (sortcombo==21): // away + home
		reportseq="147825693";
		homePair="111222333";
		awayPair="111222333";
		break;
	case (sortcombo<30): // away + sequence
		reportseq="147258369";
		homePair="123231312";
		awayPair="111222333";
		break;
	...
	sessionStorage.rubberID="h"+homePair+"v"+awayPair;
